...
class Router<EndPoint: EndPointType>: NetworkRouter {
    ...
    func request(_ route: EndPoint, completion: @escaping NetworkRouterCompletion) {
        do {
            ...
            self.apiManager.request(request.url!, method: route.httpMethod, parameters: params, encoding: URLEncoding.default, headers: request.headers).responseString(completionHandler: {response in
